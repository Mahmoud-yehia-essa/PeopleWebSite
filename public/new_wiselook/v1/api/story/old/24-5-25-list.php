...
// Add uploads path to profile pictures and story images
foreach ($stories as &$story) {
    if (!empty($story['profile_picture'])) {
        $story['profile_picture'] = $uploadsPath . $story['profile_picture'];
    } else {
        $story['profile_picture'] = $uploadsPath . 'default-profile.jpg';
    }
    
    if (!empty($story['image'])) {
        $story['image'] = $uploadsPath . $story['image'];
    }
}
