...
try {
    ...
    $stmtUpdate = $conn->prepare("UPDATE users SET password = :new_password, last_modified = :last_modified WHERE id = :client_id");
    $stmtUpdate->bindParam(':new_password', $new_password);
    $stmtUpdate->bindParam(':last_modified', $date_now);
