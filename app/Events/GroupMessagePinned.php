...
class GroupMessagePinned implements ShouldBroadcastNow
{
    use Dispatchable, InteractsWithSockets, SerializesModels;

    public function __construct(
        public $groupId,
        public $pinnedMessageId,
        public $pinnedMessage = null,
        public $pinnedBy = null,
    ...
    public function broadcastWith(): array
    {
        return [
            ...
            'pinned_message_id' => (string) $this->pinnedMessageId,
            'pinned_message' => $this->pinnedMessage,
            'pinned_by' => (string) $this->pinnedBy,
        ];
    }
}
