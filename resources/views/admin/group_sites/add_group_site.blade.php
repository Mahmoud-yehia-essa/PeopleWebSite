...
<div class="container">
    <div class="main-body">
        <div class="row">
            <div class="col-lg-8">
                <form action="{{ route('store.group_site') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input name="title" type="text" class="form-control" value="{{ old('title') }}" placeholder="أدخل عنوان المجموعة..." required />
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <textarea name="description" rows="4" class="form-control" placeholder="أدخل وصفاً للمجموعة...">{{ old('description') }}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <select name="status" id="statusSelect" class="form-select" required>
                                        <option value="open" {{ old('status', 'open') == 'open' ? 'selected' : '' }}>عامة (مفتوحة - Open)</option>
                                        <option value="closed" {{ old('status') == 'closed' ? 'selected' : '' }}>خاصة (مغلقة - Closed)</option>
                                    </select>
                            ...
                            <div class="row mb-3" id="inviteCodeContainer" style="display: {{ old('status') == 'closed' ? 'flex' : 'none' }};">
                                <div class="col-sm-3">
                                    <h6 class="mb-0">كود الدعوة (Invite Code)</h6>
                                </div>
                                <div class="col-sm-9 text-secondary">
                                    <input name="invite_code" type="text" class="form-control" value="{{ old('invite_code') }}" placeholder="أدخل كود الدعوة للمجموعة المغلقة..." />
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <select name="admin_user_id" class="form-select" required>
                                        <option value="" selected disabled>اختر المشرف المسؤول عن المجموعة...</option>
