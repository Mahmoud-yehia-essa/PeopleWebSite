            ...
            <form method="POST" action="{{ route('edit.news.category.store') }}" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        ...
                        <img id="showImage" src="{{ (!empty($value->image) && $value->image != 'non') ? 'http://localhost:8888/new_wiselook/uploads/'.basename($value->image) : url('upload/no_image.jpg') }}" alt="Preview" width="100" class="mt-2">
