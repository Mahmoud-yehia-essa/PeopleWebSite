...
<div class="col-lg-16">
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('edit.about.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                {{-- <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        ...
                        @enderror
                                ...
                                <img id="showImage" src="{{ (!empty($value->photo) && $value->photo != 'non' ) ? 'http://localhost:8888/new_wiselook/uploads/'.basename($value->photo):url('upload/no_image.jpg') }}" alt="Admin" width="110">
