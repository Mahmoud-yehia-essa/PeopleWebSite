    ...
    @endforeach
        ...
        @enderror
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <img id="showImage" src="{{ (!empty($user->profile_picture) && $user->profile_picture != 'non' ) ? 'http://localhost:8888/new_wiselook/uploads/'.$user->profile_picture : url('upload/no_image.jpg') }}" alt="Admin" width="110">
